...
public class ToyotaLuZheng extends Canbox {
    ...
    private void parseACInfo(byte[] data, int len) {
        ...
        airData[5] = (byte) ((dataAir[6] & 0x01) | ((dataAir[2] & 0x01) << 4));
        ...
        airData[9] = (byte) (((dataAir[2] & 0x10) << 1)
                ...
                | ((dataAir[6] & 0x80) >> 4) | ((dataAir[6] & 0x08) << 1) | ((dataAir[8] & 0x10) >> 3));
    ...
    public void parseCanboxData(byte[] data, int len) {
        ...
        switch (data[0]) {
            ...
            case 0x24: {
                int door = (data[2]);
                door = (((door & 0x40) >> 5) | ((door & 0x80) >> 7) | ((door & 0x10) >> 1) | ((door & 0x20) >> 3) | ((door & 0x08) << 1) | ((data[3] & 0x80) >> 2));
