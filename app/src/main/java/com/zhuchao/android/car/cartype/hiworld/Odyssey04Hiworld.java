...
public class Odyssey04Hiworld extends Canbox {
    ...
    private void initView() {
        ...
        mLayoutParams = new WindowManager.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT, 0, 0, LayoutParams.TYPE_PHONE, LayoutParams.FLAG_LAYOUT_NO_LIMITS | LayoutParams.FLAG_NOT_FOCUSABLE, PixelFormat.RGBA_8888);

        mLayoutParams.gravity = Gravity.BOTTOM;
        mLayoutParams.alpha = 0.92f;
        mMainView = ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.odysseus_old_layout, null);
    }
    ...
    private void setViewNum(int id, int num) {
        LedView v = mMainView.findViewById(id);
        if (v != null) {
            v.updateView(num);
        }
    }
