...
public class Jeep002Hiworld extends Canbox {
    ...
    public Jeep002Hiworld() {
        ...
        buildCmdRadarFront((byte) 0x41, (byte) 0x0, (byte) 2, (byte) 4, (byte) 4);
    ...
    public void parseACInfo(byte[] data) {
        ...
        airData[0] = (byte) ((data[2] & 0x08) | ((data[2] & 0x40) << 1) | ((data[3] & 0x40) >> 0) | ((data[3] & 0x10) << 1) | ((data[4] & 0x20) >> 5) | ((data[4] & 0x10) >> 3));


        airData[4] = (byte) (((data[2] & 0x20) >> 3) | ((data[4] & 0x03) << 4) | ((data[4] & 0x0c) >> 2));
    ...
    public void setMediaMoreInfo(int source, int play, int total, int time, int total_time) {
        ...
        String s = String.format("%02d:%02d:%02d   %d/%d", time / 3600, time / 60, time % 60, play, total, Locale.ENGLISH);
