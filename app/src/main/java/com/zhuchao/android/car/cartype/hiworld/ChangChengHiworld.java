...
public class ChangChengHiworld extends Canbox {
    ...
    private final static byte[][] KEYS_WHEEL2 = {
            ...
            {0x25, MyCmd.Keycode.BT}, {0x2a, MyCmd.Keycode.PLAY_PAUSE}, {0x2c, MyCmd.Keycode.MODLE}, {0x2f, MyCmd.Keycode.HOME}, {0x33, MyCmd.Keycode.RADIO}, {0x34, MyCmd.Keycode.BT_DIAL},
            {0x35, MyCmd.Keycode.BT_HANG}, {0x37, MyCmd.Keycode.SETUP}, {0x39, MyCmd.Keycode.KEY_DISPLAY}, {0x40, MyCmd.Keycode.ALL_APP}, {0x41, MyCmd.Keycode.NAVIGATION}, {0x42, MyCmd.Keycode.EQ},
            {0x61, MyCmd.Keycode.KEY_CAR_SETTING},
    };
