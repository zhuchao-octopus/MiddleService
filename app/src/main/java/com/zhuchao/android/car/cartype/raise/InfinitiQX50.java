...
//		buildCmdOutTemp((byte) 0x41, (byte) 0x10);
	...
	private final static byte[][] KEYS_WHEEL = {
		...
		{ 0x15, MyCmd.Keycode.PLAY_PAUSE },
		{ 0x16, MyCmd.Keycode.SPEED_UP },
	...
	private final static byte[][] KEYS_WHEEL2 = {
		{ 0x1, MyCmd.Keycode.POWER },
			...
			{ 0x4, MyCmd.Keycode.KEY_RADIO_PS },
			{ 0x5, MyCmd.Keycode.KEY_RADIO_SCAN },
			{ 0x6, MyCmd.Keycode.KEY_SEEK_PREV },
			{ 0x7, MyCmd.Keycode.KEY_SEEK_NEXT }, { 0x8, MyCmd.Keycode.AUDIO },
			{ 0xa, MyCmd.Keycode.ROLL_PREV },
			{ 0x9, MyCmd.Keycode.ROLL_NEXT }, { 0xb, MyCmd.Keycode.NUMBER1 },
			{ 0xc, MyCmd.Keycode.NUMBER2 }, { 0xd, MyCmd.Keycode.NUMBER3 },
			{ 0xe, MyCmd.Keycode.NUMBER4 }, { 0xf, MyCmd.Keycode.NUMBER5 },
