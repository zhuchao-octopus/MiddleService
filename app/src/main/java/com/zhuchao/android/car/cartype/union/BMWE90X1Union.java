...
public class BMWE90X1Union extends Canbox {
    ...
    private final static byte[][] KEYS_WHEEL = {{0x1, AK_KEYPAD_VOLUME_A}, {0x2, AK_KEYPAD_VOLUME_D}, {0x5, KEY_NEXTSONG}, {0x6, KEY_PREVIOUSSONG}, {0x8, KEY_BT}, {0x7, KEY_MUTE}, {0x3, KEY_SOURCE}, {0x4, KEY_HOME},
