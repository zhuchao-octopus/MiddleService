...
public class GMBinarytek extends Canbox {
    ...
    private final static byte[][] KEYS_WHEEL3 = {{0x1, MyCmd.Keycode.MODLE}, {0x2, MyCmd.Keycode.POWER}, {0x3, MyCmd.Keycode.AS}, {0x4, MyCmd.Keycode.PREVIOUS}, {0x5, MyCmd.Keycode.NEXT},
    ...
    private final static byte[][] KEYS_WHEEL = {{0x1, AK_KEYPAD_VOLUME_A}, {0x2, AK_KEYPAD_VOLUME_D}, {0x3, KEY_PREVIOUSSONG}, {0x4, KEY_NEXTSONG}, {0x5, KEY_SOURCE}, {0x6, KEY_BT}, {0x7, KEY_MUTE}, {0x8, MyCmd.Keycode.KEY_TURN_A}, {0x9, MyCmd.Keycode.KEY_TURN_D}, {0xa, MyCmd.Keycode.HOME},
