...
//		buildCmdEQ((byte) 0x27, (byte) 0x0, 6);
	...
	private final static byte[] IDS_TO_CANBOXSETTING = { (byte) 0x13,
			(byte) 0x14, (byte) 0x15, (byte) 0x71, (byte) 0x72, (byte) 0x76,
			(byte) 0x79, (byte) 0x81, (byte) 0x82, (byte) 0x83, (byte) 0x85,
			(byte) 0x94, (byte) 0xc1, (byte) 0xc2, };
...
//		{ 0x16, MyCmd.Keycode },
	...
	private final static byte[][] KEYS_WHEEL2 = {
		...
		{ 0x7, MyCmd.Keycode.HOME },
		{ 0x8, MyCmd.Keycode.MODLE },
		...
		{ 0x17, MyCmd.Keycode.KEY_SEEK_NEXT },
		{ 0x18, MyCmd.Keycode.KEY_SEEK_PREV},
		{ 0x19, MyCmd.Keycode.KEY_SEEK_PREV},
		{ 0x1a, MyCmd.Keycode.KEY_SEEK_NEXT },
		{ 0x24, MyCmd.Keycode.PLAY_PAUSE },
		{ 0x25, MyCmd.Keycode.BACK },
//		{ 0x26, MyCmd.Keycode },
//		{ 0x27, MyCmd.Keycode. },
		{ 0x28, MyCmd.Keycode.KEY_LIST },
		{ 0x2a, MyCmd.Keycode.MODLE },
		{ 0x2b, MyCmd.Keycode.BT },
		{ 0x2c, MyCmd.Keycode.MODLE },
		{ 0x2d, MyCmd.Keycode.AUDIO },
		{ 0x2e, MyCmd.Keycode.RADIO },
		{ 0x2f, MyCmd.Keycode.RADIO },
		{ 0x31, MyCmd.Keycode.AUDIO },
		{ 0x32, MyCmd.Keycode.POWER },
		{ 0x33, MyCmd.Keycode.NAVIGATION },
		{ 0x40, MyCmd.Keycode.NAVIGATION },
	};
	private final static byte[][] KEYS_WHEEL3 = {
		...
		{ 0x4, MyCmd.Keycode.ROLL_NEXT , 0},
		{ 0x14, MyCmd.Keycode.ROLL_PREV , 0},
		{ 0x5, MyCmd.Keycode.ROLL_NEXT , 0},
