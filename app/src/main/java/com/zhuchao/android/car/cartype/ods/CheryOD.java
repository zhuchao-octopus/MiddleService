...
public class CheryOD extends Canbox {
    ...
    private final static byte[][] KEYS_WHEEL = {
            ...
            {0x7, KEY_MODE}, {0x8, KEY_MIC},

            {0x10, MyCmd.Keycode.KEY_FM}, {0x11, MyCmd.Keycode.KEY_AM}, {0x12, KEY_POWER}, {0x14, KEY_NEXTSONG}, {0x13, KEY_PREVIOUSSONG}, {0x15, KEY_MUTE}, {0x16, MyCmd.Keycode.KEY_RADIO_SCAN},
