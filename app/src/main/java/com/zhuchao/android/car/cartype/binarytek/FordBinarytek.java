...
//		buildCmdOutTemp((byte) 0x41, (byte) 0x10);
	...
	private final static byte[] IDS_TO_CANBOXSETTING = { 0x27,0x24,
		0x28,0x2a,0x50,0x51,0x52,0x53,0xd,0x68,0x69,0x6a,0x6c,
		0x7a,0x70,0x71,0x72,0x78,0x79};
	
	private final static byte[][] KEYS_WHEEL = {
		{ 0x1, MyCmd.Keycode.VOLUME_UP },
		{ 0x2, MyCmd.Keycode.VOLUME_DOWN },
		{ 0x3, MyCmd.Keycode.MULT_NEXT_AND_HANG },
		{ 0x4, MyCmd.Keycode.MULT_PREV_AND_RECEIVE },
		{ 0x5, MyCmd.Keycode.BT },
		{ 0x7, MyCmd.Keycode.MODLE },
		{ 0xe, MyCmd.Keycode.PREVIOUS },
		{ 0xf, MyCmd.Keycode.NEXT },
		{ 0x10, MyCmd.Keycode.PREVIOUS },
		{ 0x11, MyCmd.Keycode.NEXT },
		{ 0x12, MyCmd.Keycode.PLAY_PAUSE },
		{ 0x18, MyCmd.Keycode.SPEECH },
		{ 0x20, MyCmd.Keycode.NUMBER0 },
		...
		{ 0x27, MyCmd.Keycode.NUMBER7 },
		{ 0x28, MyCmd.Keycode.NUMBER8 },
		{ 0x29, MyCmd.Keycode.NUMBER9 },
		{ 0x2a, MyCmd.Keycode.NUMBER_STAR },
		{ 0x2b, MyCmd.Keycode.NUMBER_POUND },
		{ 0x33, MyCmd.Keycode.AS },
		{ 0x34, MyCmd.Keycode.RADIO },
		{ 0x35, MyCmd.Keycode.DVD },
		{ 0x36, MyCmd.Keycode.AUX_IN },
		{ 0x37, MyCmd.Keycode.HOME },
		{ 0x38, MyCmd.Keycode.EQ },
		{ 0x39, MyCmd.Keycode.BT },
		{ 0x3d, MyCmd.Keycode.TIME_SETTING },
		{ 0x3f, MyCmd.Keycode.POWER },
		{ 0x48, MyCmd.Keycode.PLAY_PAUSE },
		{ 0x49, MyCmd.Keycode.PREVIOUS },
		{ 0x4a, MyCmd.Keycode.NEXT },
		{ 0x4b, MyCmd.Keycode.PREVIOUS },
		{ 0x4c, MyCmd.Keycode.NEXT },
		{ 0x52, MyCmd.Keycode.MULT_PREV_AND_RECEIVE },
		{ 0x53, MyCmd.Keycode.MULT_NEXT_AND_HANG },
		{ 0x54, MyCmd.Keycode.EJECT },
		{ 0x56, MyCmd.Keycode.KEYAMS_RPT },
		{ 0x57, MyCmd.Keycode.SETUP },
		{ 0x59, MyCmd.Keycode.EQ },
		{ 0x5a, MyCmd.Keycode.MUTE },
		{ 0x5b, MyCmd.Keycode.KEY_DISPLAY },
		{ 0x5c, MyCmd.Keycode.PREVIOUS },
		{ 0x5d, MyCmd.Keycode.PREVIOUS },
		{ 0x5e, MyCmd.Keycode.NEXT },
		{ 0x5f, MyCmd.Keycode.NEXT },
		{ (byte)0xF0, MyCmd.Keycode.VOLUME_ROLL_UP },
	...
	public void setMediaMoreInfo(int source, int play, int total, int time,
		...
		default:
			...
			mData = new byte[] { (byte) 0xc0, 0x8, s, s2, 
					(byte) ((total) & 0xFF), (byte) ((total & 0xFF00) >> 8), 
