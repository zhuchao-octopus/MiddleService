...
public class Infiniti001Hiworld extends Canbox {
    ...
    public void parseACInfo(byte[] data) {
        ...
        airData[0] = (byte) (((data[2] & 0x40) << 1) | ((data[2] & 0x08) << 0) | ((data[3] & 0x10) << 1) | ((data[3] & 0x44) << 0) | ((data[4] & 0x20) >> 5) | ((data[4] & 0x10) >> 3));


        airData[4] = (byte) (((data[2] & 0x03) << 0) | ((data[4] & 0x03) << 4) | ((data[3] & 0x02) << 2) | ((data[3] & 0x44) << 0));
        ...
        airData[8] = (byte) (((data[2] & 0x04) >> 2) | ((data[4] & 0x04) >> 1));

        airData[9] = (byte) (((data[4] & 0x4) << 4) | ((data[2] & 0x4) >> 0) | ((data[4] & 0x80) >> 2) | ((data[3] & 0x80) >> 3) | ((data[3] & 0x01) << 1) | ((data[2] & 0x10) << 3));
