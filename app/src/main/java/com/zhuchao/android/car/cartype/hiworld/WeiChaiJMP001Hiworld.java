...
public class WeiChaiJMP001Hiworld extends Canbox {
    ...
    private final static byte[][] KEYS_WHEEL2 = {
            {0x1, MyCmd.Keycode.POWER}, {0x6, MyCmd.Keycode.BACK}, {0x16, MyCmd.Keycode.PLAY_PAUSE}, {0x17, MyCmd.Keycode.PREVIOUS}, {0x18, MyCmd.Keycode.NEXT}, {0x19, MyCmd.Keycode.PREVIOUS},
            {0x1a, MyCmd.Keycode.NEXT}, {0x2b, MyCmd.Keycode.HOME}, {0x41, MyCmd.Keycode.NAVIGATION}, {0x45, MyCmd.Keycode.VOLUME_UP}, {0x46, MyCmd.Keycode.VOLUME_DOWN},
    };
