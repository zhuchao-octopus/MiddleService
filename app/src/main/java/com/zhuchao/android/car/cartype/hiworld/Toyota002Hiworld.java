...
public class Toyota002Hiworld extends Canbox {
    ...
    public void parseACInfo(byte[] data) {
        ...
        airData[0] = (byte) ((data[2] & 0x0c) | ((data[2] & 0x40) << 1) | ((data[6] & 0x02) >> 0) | ((data[6] & 0x08) >> 3) | ((data[6] & 0x04) << 4));
        ...
        airData[9] = (byte) (((data[2] & 0x02) << 3) | ((data[2] & 0x01) << 5) | ((data[6] & 0x01) << 3));


        airData[12] = (byte) (((data[6] & 0x10) << 2));
