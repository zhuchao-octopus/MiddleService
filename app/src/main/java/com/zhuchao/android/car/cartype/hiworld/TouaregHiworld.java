...
public class TouaregHiworld extends Canbox {
    ...
    public TouaregHiworld() {
        ...
        sendCmd(CANBOX_WRITE_MCU_DATA, 0, new byte[]{
                0x05, 0x02, 0x2, 0x0, 0x3, 0x2
        });
    }

    private final static byte[][] KEYS_WHEEL = {
            {0x1, AK_KEYPAD_VOLUME_A}, {0x2, AK_KEYPAD_VOLUME_D}, {0x9, KEY_NEXTSONG}, {0x8, KEY_PREVIOUSSONG}, {0x5, KEY_BT_DIAL}, {0x6, KEY_BT_HANG}, {0x3, KEY_MUTE}, {0xa, KEY_SOURCE},
