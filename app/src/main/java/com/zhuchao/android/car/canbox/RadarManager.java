...
public class RadarManager {
    ...
    public static View init(Context context) {
        mContext = context;
        if (mView == null) {
            mView = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.radar, null);
    ...
    public static void start(Context context) {
        ...
        if (!isShow) {// && !ReverseManager.isShow) {
            ...
            if (mRadarUI == null) {
                mRadarUI = RadarUI.getInstanse(context, mView.findViewById(R.id.screen1_radar), 0);
            }
            mRadarUI.onCreate();
            mRadarUI.onResume();
            isShow = true;
    ...
    public static void updateView(int type) {
        ...
        if (type == 0) {
            ...
            mLayoutParams.x = 0;
            mLayoutParams.y = 0;
            mView.findViewById(R.id.reverse_left_image).setVisibility(View.VISIBLE);
            ...
            mView.findViewById(R.id.reverse_left_image).setVisibility(View.GONE);
        }
