...
public class GMOD extends Canbox {
	...
	private final static byte[][] KEYS_WHEEL2 = {
		...
		{ 0x17, AK_KEYPAD_VOLUME_A },
			...
			{ 0x50, MyCmd.Keycode.HOME },
			{ 0x51, MyCmd.Keycode.MODLE },
			{ 0x52, MyCmd.Keycode.RDS_TA_SWITCH },
			{ 0x53, MyCmd.Keycode.MENU },
			{ 0x54, MyCmd.Keycode.AUDIO },
...
//			break;
			...
			if (data[2] == 1) {
				if (!"com.canboxsetting/com.canboxsetting.JeepCarCDPlayerActivity"
						...
						it.setClassName("com.canboxsetting",
								"com.canboxsetting.JeepCarCDPlayerActivity");
		...
		if (data[0] == 0x40 || data[0] == 0x41 || data[0] == 0x50
				|| data[0] == 0x63 || data[0] == 0x21 || data[0] == 0x25
				|| data[0] == 0x16) {
			sendCanboxInfo("com.canboxsetting", data);
		}
	}
