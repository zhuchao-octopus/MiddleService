...
public class JeepBNR extends Canbox {
    ...
    private final static byte[][] KEYS_WHEEL = {
            ...
            {0x7, KEY_SOURCE}, {0x8, KEY_MIC}, {0x9, KEY_BT_DIAL}, {0xa, KEY_BT_HANG},

            {0x12, KEY_PLAYPAUSE},

            {0x13, KEY_MUTE}, {0x14, MyCmd.Keycode.DARK},

            {0x15, KEY_BACK}, {0x16, KEY_PLAYPAUSE},


            {0x17, MyCmd.Keycode.VOLUME_ROLL_UP}, {0x18, MyCmd.Keycode.VOLUME_ROLL_DOWN},

            {0x19, MyCmd.Keycode.ROLL_NEXT}, {0x20, MyCmd.Keycode.ROLL_PREV}, {0x21, KEY_POWER},
    ...
    private void parseACInfo(byte[] data, int len) {
        ...
        airData[7] = (byte) (((data[6] & 0x10) >> 4) | ((data[6] & 0x02) << 5));
        ...
        if (airData[0] != (byte) (mAirData[0] & 0xff) || airData[1] != (byte) (mAirData[1] & 0xff) || airData[2] != (byte) (mAirData[2] & 0xff) || airData[3] != (byte) (mAirData[3] & 0xff) || airData[4] != (byte) (mAirData[4] & 0xff) || airData[5] != (byte) (mAirData[5] & 0xff) || airData[6] != (byte) (mAirData[6] & 0xff) || airData[7] != (byte) (mAirData[7] & 0xff)) {
            airControl = true;
    ...
    public void parseCanboxData(byte[] data, int len) {
        ...
        switch (data[0]) {
            ...
            case 0x22: // Radar back
            {
                ...
                if (mRadar[0] != 0 || mRadar[1] != 0 || mRadar[2] != 0 || mRadar[3] != 0) {
            ...
            case 0x23: // Radar back
            {
                ...
                if (mRadar[4] != 0 || mRadar[5] != 0 || mRadar[6] != 0 || mRadar[7] != 0) {
                    boolean zero = Util.isZero(mRadar);
                    if (!zero) {
                        RadarManager.start(mContext);
                        checkHideRadarEx(2000);
