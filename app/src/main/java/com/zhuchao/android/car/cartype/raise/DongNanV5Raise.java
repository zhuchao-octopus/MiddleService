...
public class DongNanV5Raise extends Canbox {
    ...
    private final static byte[][] KEYS_WHEEL = {
            ...
            {0x25, MyCmd.Keycode.MULT_MUTE_AND_POWER}, {0x26, MyCmd.Keycode.SETUP}, {0x21, MyCmd.Keycode.RADIO}, {0x22, MyCmd.Keycode.AUDIO}, {0x23, MyCmd.Keycode.NAVIGATION},
    ...
    private final static byte[][] KEYS_WHEEL2 = {
            ...
            {0xe, MyCmd.Keycode.MENU}, {0xf, MyCmd.Keycode.AUDIO}, {0x10, MyCmd.Keycode.BACK}, {0x11, MyCmd.Keycode.SETUP}, {0x12, MyCmd.Keycode.NAVIGATION}, {0x13, MyCmd.Keycode.NAVIGATION},
            {0x14, MyCmd.Keycode.PLAY_PAUSE}, {0x16, MyCmd.Keycode.ROLL_PREV}, {0x17, MyCmd.Keycode.ROLL_NEXT},
    };
