...
import com.zhuchao.android.camera.camera2.Camera2Config;
import com.zhuchao.android.camera.camera2.Camera2Recorder;
import com.zhuchao.android.camera.camera2.Camera2Util;
...
public class RecordService extends Service {
    ...
    private Camera2Recorder mRecordVideoMode;
    ...
    private final Runnable mStopRecordRunnable = new Runnable() {
        ...
        public void run() {
            if (null != mRecordVideoMode) {
                mRecordVideoMode.stopRecorder();
            }
        }
    };
    private LinearLayout mLinearLayout;
    private WindowManager mWindowManager;
    private List<Camera2Config> mCameraConfigList;
    ...
    public void onCreate() {
        ...
        mCameraConfigList = Camera2Util.getCameraInfo(this);
        mRecordVideoMode = new Camera2Recorder(mContext, mCameraConfigList.get(0));
        ///initView();
    }
    ...
    public void onDestroy() {
        ...
        if (null != mRecordVideoMode) mRecordVideoMode.releaseCamera();
        releaseView();
    }
    ...
    private void initView() {
        ...
        ///TOpenCVCamera2 mTOpenCVCamera2 = new TOpenCVCamera2(this);
