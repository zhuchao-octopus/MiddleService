...
public class NissanHiworld extends Canbox {
    ...
    public NissanHiworld() {
        ...
        buildCmdRadarFront((byte) 0x41, (byte) 0x1, (byte) 3, (byte) 4, (byte) 4);
    ...
    public int getAngleValue2(byte[] data) {
        ...
        short angle = (short) ((data[7] & 0xff) | ((data[6] & 0xff) << 8));
    ...
    public void parseACInfo(byte[] data) {
        ...
        airData[0] = (byte) ((data[2] & 0x08) | ((data[2] & 0x48) << 1) | ((data[2] & 0x01) << 6) | ((data[3] & 0x40) << 0) | ((data[3] & 0x10) << 1) | ((data[3] & 0x04) << 0) | ((data[4] & 0x20) >> 5) | ((data[4] & 0x10) >> 3));

        airData[4] = (byte) (((data[4] & 0x03) << 4) | ((data[4] & 0x0c) >> 2) | ((data[2] & 0x20) >> 3) | ((data[3] & 0x80) >> 4) | ((data[3] & 0x08) << 4));


        airData[8] = (byte) (((data[5] & 0x30) << 0) | ((data[5] & 0xc0) >> 4));
