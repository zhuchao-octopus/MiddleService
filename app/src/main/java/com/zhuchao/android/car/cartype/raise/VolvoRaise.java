...
public class VolvoRaise extends Canbox {
    ...
    public void parseACInfo(byte[] data) {
        ...
        airData[0] = (byte) ((data[2] & 0xf0) | ((data[2] & 0x0e) >> 1));
        ...
        if ((((data[4] & 0xff) >= 0x3c) && ((data[4] & 0xff) <= 0x57)) || (((data[5] & 0xff) >= 0x3c) && ((data[5] & 0xff) <= 0x57))) {
            airData[5] = 0x1;
        }


        airData[4] = (byte) (((data[6] & 0x0c) >> 2) | ((data[6] & 0x03) << 4));
