    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (i = 0; i < BackTrack.show_l_num; i++) {
            ...
            if (startX != 0 && startY != 0) {
                canvas.drawLine((float) startX, (float) startY, (float) xy_l_screen_x[i], (float) xy_l_screen_y[i], paint);
            }
        ...
        for (i = 0; i < BackTrack.show_r_num; i++) {
            ...
            if (startX != 0 && startY != 0) {
                canvas.drawLine((float) startX, (float) startY, (float) xy_r_screen_x[i], (float) xy_r_screen_y[i], paint);
            }
        ...
        for (i = 0; i < BackTrack.SAWTOOTH_NUM; i++) // »­¾â³Ý
        {
            ...
            if (i == 6) {
                ...
                canvas.drawLine((float) xy_l_screen_x[l], (float) xy_l_screen_y[l], (float) xy_r_screen_x[r], (float) xy_r_screen_y[r], mPaint1);
