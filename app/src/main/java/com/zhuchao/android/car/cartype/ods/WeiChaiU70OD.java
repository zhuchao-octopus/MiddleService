...
public class WeiChaiU70OD extends Canbox {
    ...
    private final static byte[][] KEYS_WHEEL = {
            ...
            {0x6, MyCmd.Keycode.MUTE}, {0x7, MyCmd.Keycode.MODLE}, {0x8, MyCmd.Keycode.BT}, {0x9, MyCmd.Keycode.BT_DIAL}, {0xa, MyCmd.Keycode.BT_HANG}, {0xb, MyCmd.Keycode.SPEECH},
            {0xc, MyCmd.Keycode.BACK}, {0xd, MyCmd.Keycode.POWER}, {0xe, MyCmd.Keycode.HOME},
    };
