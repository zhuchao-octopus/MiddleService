...
public class ReverseUI extends UIBase implements View.OnClickListener, SurfaceHolder.Callback {
    ...
    public void onCreate() {
        ...
        } else if (MachineConfig.VALUE_SYSTEM_UI20_RM10_1.equals(GlobalDefinition.mSystemUI) || MachineConfig.VALUE_SYSTEM_UI21_RM10_2.equals(GlobalDefinition.mSystemUI) || MachineConfig.VALUE_SYSTEM_UI21_RM12.equals(GlobalDefinition.mSystemUI)) {
    ...
    private void showHYUI(byte[] data) {
        ...
        try {
            ...
            ((RadioButton) view).setChecked((data[1] & 0x80) != 0);

            view = mMainView.findViewById(R.id.can15_warning_settings);
            ((RadioButton) view).setChecked((data[1] & 0x40) != 0);
