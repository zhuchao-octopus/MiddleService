...
public class BydCYT extends Canbox {
    ...
    private final static byte[][] KEYS_WHEEL = {
            ...
            {0x7, MyCmd.Keycode.MODLE}, {0x8, MyCmd.Keycode.SPEECH}, {0x9, MyCmd.Keycode.BT_DIAL}, {0xa, MyCmd.Keycode.BT_HANG}, {0xb, MyCmd.Keycode.KEY_SIDE_CAMERA}, {0xc, MyCmd.Keycode.POWER},
            {0xd, MyCmd.Keycode.ROLL_NEXT}, {0xe, MyCmd.Keycode.ROLL_PREV}, {0xf, MyCmd.Keycode.PLAY_PAUSE}, {0x10, MyCmd.Keycode.NAVIGATION}, {0x11, MyCmd.Keycode.RADIO},
            {0x12, MyCmd.Keycode.KEY_AIR_CONTROL},
    };
