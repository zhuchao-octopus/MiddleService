...
public class ZongTaiBNR extends Canbox {
    ...
    public void parseACInfo(byte[] data) {
        ...
        airData[0] = (byte) ((data[2] & 0xe0) | ((data[2] & 0x10) >> 4) | ((data[2] & 0x08) >> 2) | ((data[2] & 0x04) << 2) | ((data[3] & 0x10) >> 2));

        airData[1] = (byte) ((data[3] & 0x07) | ((data[3] & 0x80) >> 1) | ((data[3] & 0x40) >> 1) | ((data[3] & 0x20) << 2));
        ...
        airData[4] = (byte) ((data[7] & 0x33) | ((data[2] & 0x02) << 1));
