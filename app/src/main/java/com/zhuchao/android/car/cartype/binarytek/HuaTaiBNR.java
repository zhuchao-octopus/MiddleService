...
public class HuaTaiBNR extends Canbox {
    ...
    private final static byte[][] KEYS_WHEEL = {
            {0x11, MyCmd.Keycode.MODLE}, {0x12, MyCmd.Keycode.PREVIOUS}, {0x13, MyCmd.Keycode.NEXT}, {0x14, MyCmd.Keycode.VOLUME_UP}, {0x15, MyCmd.Keycode.VOLUME_DOWN}, {0x16, MyCmd.Keycode.MUTE},
