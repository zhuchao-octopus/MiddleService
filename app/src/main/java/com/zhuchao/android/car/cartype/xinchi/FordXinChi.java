...
public class FordXinChi extends Canbox {
    ...
    public void parseACInfo(byte[] data) {
        ...
        airData[0] = (byte) ((data[2] & 0xd0) | ((data[2] & 0x04) << 3) | ((data[2] & 0x20) >> 3) | ((data[3] & 0x80) >> 6) | ((data[2] & 0x02) >> 1));


        airData[1] = (byte) (((data[4] & 0x40) << 1) | ((data[4] & 0x10) << 2) | ((data[4] & 0x20) >> 0));


        airData[12] = (byte) (((data[3] & 0x10) << 1) | ((data[3] & 0x20) >> 5));
        ...
        airData[5] = (byte) (((data[4] & 0x08) << 1) | ((data[4] & 0x01) << 0));
    ...
    public void parseACInfoEx(byte[] data) {
        ...
        airData[11] = (byte) ((data[2] & 0x0f) | ((data[3] & 0x80) >> 2) | ((data[3] & 0x40) << 0));
