    ...
    public void parseCanboxData(byte[] data, int len) {
        ...
        switch (data[0]) {
            ...
            case 0x22: // Radar back
            {
                ...
                if (null != handler) {
                    checkHideRadar();
                    handler.sendMessage(handler.obtainMessage(CANBOX_RADAR_BACK, 0, 0));
                }
            ...
            case 0x27: {
                ...
                String s = String.format("%d.%d%s", temp / 2, ((temp * 10 / 2) % 10), mContext.getResources().getString(R.string.temp_unic_centigrade));
                if ((data[2] & 0x80) != 0) {
                    s = "-" + s;
                }
