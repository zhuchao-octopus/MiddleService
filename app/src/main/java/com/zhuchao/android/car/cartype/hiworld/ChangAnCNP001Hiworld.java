...
public class ChangAnCNP001Hiworld extends Canbox {
    ...
    private final static byte[][] KEYS_WHEEL = {{0x1, MyCmd.Keycode.VOLUME_UP}, {0x2, MyCmd.Keycode.VOLUME_DOWN}, {0x3, MyCmd.Keycode.MUTE}, {0x4, MyCmd.Keycode.SPEECH},
            ...
            {0xc, MyCmd.Keycode.MODLE}, {0xd, MyCmd.Keycode.NEXT}, {0xe, MyCmd.Keycode.PREVIOUS}, {0xf, MyCmd.Keycode.PLAY_PAUSE},

            {0x10, MyCmd.Keycode.BACK},

    };
    private final static byte[][] KEYS_WHEEL2 = {{0x1, MyCmd.Keycode.POWER}, {0x9, MyCmd.Keycode.MUTE},
            //		{ 0x2, MyCmd.Keycode.PREVIOUS },
            //		{ 0x3, MyCmd.Keycode.NEXT },
            {0x2b, MyCmd.Keycode.HOME}, {0x2d, MyCmd.Keycode.AUDIO}, {0x45, MyCmd.Keycode.VOLUME_UP}, {0x46, MyCmd.Keycode.VOLUME_DOWN},
            //		{ 0x60, MyCmd.Keycode. },
    };

    public ChangAnCNP001Hiworld() {
