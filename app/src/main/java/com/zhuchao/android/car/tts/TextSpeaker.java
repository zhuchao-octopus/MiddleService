    ...
    public static void speakDirect(Context context, String text) {
        ...
        if (mTextSpeaker == null) {
            ...
            if (mTextSpeaker.mTextToSpeech != null) {
                mTextSpeaker.mTextToSpeech.speak(text, TextToSpeech.QUEUE_FLUSH, null);
            }
        }
    }

    public static TextSpeaker getInstance(Context context, Locale locale, OnTextSpeakerResult onResult) {
        // if (mTextSpeaker == null) {
