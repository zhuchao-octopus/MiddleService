...
public class MondeoDaojun extends Canbox {
    ...
    private final static byte[][] KEYS_WHEEL = {
            {0x1, MyCmd.Keycode.VOLUME_UP}, {0x2, MyCmd.Keycode.VOLUME_DOWN}, {0x3, MyCmd.Keycode.MULT_NEXT_AND_HANG}, {0x4, MyCmd.Keycode.MULT_PREV_AND_RECEIVE}, {0x5, MyCmd.Keycode.SPEECH},//yihu
            ...
            //		{ 0x1d, MyCmd.Keycode. },
            {0x1e, MyCmd.Keycode.AUDIO}, {0x1f, MyCmd.Keycode.HOME}, {0x20, MyCmd.Keycode.NUMBER0}, {0x21, MyCmd.Keycode.NUMBER1}, {0x22, MyCmd.Keycode.NUMBER2}, {0x23, MyCmd.Keycode.NUMBER3},
            {0x24, MyCmd.Keycode.NUMBER4}, {0x25, MyCmd.Keycode.NUMBER5}, {0x26, MyCmd.Keycode.NUMBER6}, {0x27, MyCmd.Keycode.NUMBER7}, {0x28, MyCmd.Keycode.NUMBER8}, {0x29, MyCmd.Keycode.NUMBER9},
            {0x2a, MyCmd.Keycode.NUMBER_STAR}, {0x2b, MyCmd.Keycode.NUMBER_POUND}, {0x33, MyCmd.Keycode.RADIO}, {0x34, MyCmd.Keycode.RADIO}, {0x35, MyCmd.Keycode.DVD}, {0x36, MyCmd.Keycode.AUX_IN},
            {0x37, MyCmd.Keycode.MENU}, {0x38, MyCmd.Keycode.EQ}, {0x39, MyCmd.Keycode.BT}, {0x3d, MyCmd.Keycode.TIME_SETTING}, {0x3f, MyCmd.Keycode.POWER}, {0x48, MyCmd.Keycode.PLAY_PAUSE},
            ...
            {0x53, MyCmd.Keycode.MULT_NEXT_AND_HANG}, {0x54, MyCmd.Keycode.EJECT}, {0x56, MyCmd.Keycode.AS}, {0x57, MyCmd.Keycode.SETUP}, {0x59, MyCmd.Keycode.EQ}, {0x5a, MyCmd.Keycode.MUTE},
            {0x5b, MyCmd.Keycode.KEY_DISPLAY}, {0x5c, MyCmd.Keycode.PREVIOUS}, {0x5d, MyCmd.Keycode.PREVIOUS}, {0x5e, MyCmd.Keycode.NEXT}, {0x4f, MyCmd.Keycode.NEXT},
