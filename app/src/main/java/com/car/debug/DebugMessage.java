	...
	private static void init(Context context) {
		...
		if (mView == null) {
			...
			mView = ((LayoutInflater) context
					...
					.inflate(R.layout.debug_msg, null);

			
			mLayoutParams = new WindowManager.LayoutParams(660, 400, 0, 0,
			...
			mView.findViewById(R.id.rx).setOnClickListener(
					new OnClickListener() {
			...
			mView.findViewById(R.id.tx).setOnClickListener(
					new OnClickListener() {
			...
			mView.findViewById(R.id.stop_debug).setOnClickListener(
					new OnClickListener() {
						...
						public void onClick(View arg0) {
							...
							if (mDebug != null) {
								...
								mDebug = (TextView) mView
										.findViewById(R.id.msg_debug);
								((TextView) arg0).setTextColor(0xffffffff);
							}
						}
					});

			mView.findViewById(R.id.export).setOnClickListener(
					new OnClickListener() {
			...
			mView.findViewById(R.id.switch_debug).setOnClickListener(
					new OnClickListener() {
			...
			mView.findViewById(R.id.quit_debug).setOnClickListener(
					new OnClickListener() {
		...
		mDebug = (TextView) mView.findViewById(R.id.msg_debug);
...
//			mContext = null;
	...
	private static void initListView(){
		mListView = (ListView)mView.findViewById(R.id.tv_sd_list);
