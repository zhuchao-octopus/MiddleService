...
public class ReverseUICanbox {
	...
	private final static int[][] IDS_VW = 
		...
		{ R.id.vw_l, 0xc64605 },
		{ R.id.vw_lr, 0xc64606 },
		{ R.id.vw_radar_v_off, 0xc6ab00 },
		{ R.id.vw_radar_v_on, 0xc6ab01 },
	...
	private final IdConfig[] mIdConfig = { new IdConfig(46,
			R.id.layout_canbus_vw, IDS_VW, mOnClickListener)
	...
	private void initVW() {
		...
		mTvBacklight = ((TextView)mMainView.findViewById(R.id.backlight_text));
		mTvConrast = ((TextView)mMainView.findViewById(R.id.contrast_text));
		mTvSaturation = ((TextView)mMainView.findViewById(R.id.saturation_text));

		mMainView.findViewById(R.id.contrast_layout).setVisibility(
				View.VISIBLE);
		mMainView.findViewById(R.id.saturation_layout).setVisibility(
				View.VISIBLE);
		
		mLevelContrast = (SeekBar) mMainView
				.findViewById(R.id.contrast_level);
		...
		mLevelSaturation = (SeekBar) mMainView
				.findViewById(R.id.saturation_level);
	...
	private void setViewSrc(int id, int resId) {
		ImageView v = (ImageView) mMainView.findViewById(id);
		if (v != null) {
	...
	private void updateVWView(int arg1, int arg2) {
		if (arg1 == 0x40) {
			...
			mTvBacklight.setText("" + b);
			mTvBacklight.setVisibility(View.VISIBLE);
			mTvSaturation.setText("" + s);
			mTvConrast.setText("" + c);
	...
	public void doMsg(int msg, int arg1, int arg2){
		try {
			switch (msg) {
			case Canbox.CANBOX_VW_RAISE_UI_DATA:
