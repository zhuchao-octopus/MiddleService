...
import static com.my.cartype.CarUtil.sendDataToCanbox;
...
public class ReverseUI extends UIBase implements View.OnClickListener,
	...
	public void onCreate() {
		...
		mMainView.findViewById(R.id.screen1_main).getTag();
		...
		} else if (MachineConfig.VALUE_SYSTEM_UI20_RM10_1.equals(GlobalDef.mSystemUI)
...
//			}
	...
	private void noSignalShowText(int s) {
		Log.d("allen", "no Signal ShowText:" + s);
		if (mSignalView != null) {
