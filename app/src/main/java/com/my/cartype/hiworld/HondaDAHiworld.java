...
//		buildCmdOutTemp((byte) 0x41, (byte) 0x10);
	...
	private final static byte IDS_TO_CANBOXSETTING[] = { 0x11,
		0x12, 0x16, 0x17,
			0x32, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x75, (byte) 0x84,
			(byte) 0x85, (byte) 0x87, (byte) 0x89, (byte) 0xa4, (byte) 0xe8 };
	...
	private final static byte KEYS_WHEEL[][] = {
		...
		{ 0x5b, MyCmd.Keycode.KEY_SEEK_NEXT },
		{ 0x5c, MyCmd.Keycode.KEY_SEEK_PREV },
		{ 0x5d, MyCmd.Keycode.NEXT },
		{ 0x5e, MyCmd.Keycode.PREVIOUS },
	...
	private final static byte KEYS_WHEEL2[][] = {
		...
		{ 0x22, MyCmd.Keycode.ALL_APP },
		{ 0x23, MyCmd.Keycode.KEY_FM },
		{ 0x24, MyCmd.Keycode.KEY_AM },
	...
	public void setMediaMoreInfo(int source, int play, int total, int time,
		...
		if (CarUtil.getModelId() == 68 || CarUtil.getModelId() == 8) {
			s = String.format("%03d %02d%02d", play, time / 60, time % 60,
					Locale.ENGLISH);
		} else {
...
//			return;
	...
	public void parseEQ(int id, byte[] buf) {
		...
		mEQData[0] = (byte) (buf[7] );
		mEQData[1] = (byte) (buf[6] );
		mEQData[2] = (byte) (buf[5] );
		mEQData[3] = (byte) (buf[4] );
...
//		if (CarUtil.getModelId() == 68 || CarUtil.getModelId() == 8) {
	...
	public void setSongName(String s) {
		...
		if (CarUtil.getModelId() == 29
				|| (CarUtil.getModelId() == 8 && CarUtil.getCarTypeConfig() == 2)) {
			sendId3Unicode((byte) 0xe4, s, 0x20, 0);
		} else if (CarUtil.getModelId() == 20 || CarUtil.getModelId() == 26
				|| CarUtil.getModelId() == 19 || CarUtil.getModelId() == 59) {
	...
	public void updateCompass(int compass) {
		...
		byte[] buf = new byte[] { 0x13, (byte) (0x94), 
