...
public class VWMQBHiworld extends Canbox{
	...
	private final static byte IDS_TO_CANBOXSETTING[] = { 0x13, 0x14, 0x15,
			0x16, 0x17, 0x18, 0x19, 0x35, 0x45, 0x46, 0x47, 0x48, 0x49, 0x67, 0x68,
			0x69, 0x64, 0x76, 0x1f, 0x1e, 0x75, 0x77, 0x74, 0x36, 0x48,
			(byte) 0x85, (byte) 0x87, (byte) 0x88, (byte) 0xc1, (byte) 0xf0,
			(byte) 0xc2, (byte) 0x1f, (byte) 0xe8, };
...
//		Log.d("cccc", ""+curDate.getYear());
		...
		byte[] buf = new byte[] { 0x0a, (byte) 0xcb, 1, h, m, 0, (byte) zone,
				ampm, y, mon, d, format };
