...
//		buildCmdEQ((byte) 0x27, (byte) 0x0, 6);
	...
	private final static byte IDS_TO_CANBOXSETTING[] = { (byte) 0x32,
			(byte) 0xf2 };
	...
	private byte KEYS_WHEEL2[][] = {
		...
		{ 0x43, MyCmd.Keycode.MUTE },
		{ 0x47, MyCmd.Keycode.BT_DIAL },
		{ 0x48, MyCmd.Keycode.BT_HANG },

		{ 0x49, MyCmd.Keycode.RADIO },
		{ 0x4a, MyCmd.Keycode.SETUP },
		{ 0x4b, MyCmd.Keycode.NAVIGATION },
		};
