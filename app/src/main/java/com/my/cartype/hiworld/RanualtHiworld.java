...
public class RanualtHiworld extends Canbox{
	...
	private Handler mHandlerSendLcd = new Handler() {
...
//		mHandlerSendLcd.sendEmptyMessageDelayed(0, 1000);
	...
	private final static byte IDS_TO_CANBOXSETTING[] = { (byte) 0x13,
			(byte) 0x14, (byte) 0x1b, 0x26, 0x31, 0x61, 0x62 };
	
	private final static byte KEYS_WHEEL[][] = {
		{ 0x1, MyCmd.Keycode.VOLUME_UP },
		{ 0x2, MyCmd.Keycode.VOLUME_DOWN },
		{ 0x3, MyCmd.Keycode.MULT_MUTE_AND_BT },
		...
		{ 0x10, MyCmd.Keycode.MULT_SOURCE_AND_BT },
	...
	//		break;
		...
		if (CarUtil.getCarTypeConfig() == 2 || CarUtil.getModelId() == 11){
			...
			if (null != handler) {
				...
				handler.sendMessage(handler.obtainMessage(CANBOX_DACIA_UI_DATA,
						arg, 0));
			}
	...
	public void setMediaMoreInfo(int source, int play, int total, int time,
		...
		String s = String.format("00%d %02d%02d   ", play % 10, time / 60,
