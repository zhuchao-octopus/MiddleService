...
//		{ 0x7, MyCmd.Keycode },
		...
		{ 0x62, MyCmd.Keycode.PAUSE },
		{ 0x65, MyCmd.Keycode.EJECT },
		
	};
	
	private final static byte KEYS_WHEEL2[][] = {
		{ 0x1, MyCmd.Keycode.POWER },
		{ 0x2, MyCmd.Keycode.KEY_SEEK_PREV },
		...
		{ 0x2d, MyCmd.Keycode.RADIO },
		{ 0x2e, MyCmd.Keycode.AS },
		{ 0x30, MyCmd.Keycode.NUMBER7 },
		{ 0x31, MyCmd.Keycode.NUMBER8 },
		{ 0x32, MyCmd.Keycode.NUMBER9 },
		{ 0x33, MyCmd.Keycode.NUMBER0 },
		{ 0x34, MyCmd.Keycode.NUMBER_STAR },
		{ 0x35, MyCmd.Keycode.NUMBER_POUND },

//		{ 0x36, MyCmd.Keycode },
//		{ 0x37, MyCmd.Keycode },
//		{ 0x38, MyCmd.Keycode },
//		{ 0x39, MyCmd.Keycode },
		{ 0x3a, MyCmd.Keycode.DVD },
		{ 0x3b, MyCmd.Keycode.AUDIO },
		{ 0x3c, MyCmd.Keycode.KEY_TURN_A },
		{ 0x3d, MyCmd.Keycode.KEY_TURN_D },
		{ 0x3e, MyCmd.Keycode.AS },
		{ 0x3f, MyCmd.Keycode.HOME },
	...
	private byte[] mLcdInfo = new byte[16];
