...
public class SpiriorDaoJun extends Canbox {
	...
	private final static byte IDS_TO_CANBOXSETTING[] = {  0x16,
			0x17,   0x65, 0x66, 0x67, 0x68, 0x69, 0x75,0x76, (byte) 0x84,
			(byte) 0x85 };
	...
	private final static byte KEYS_WHEEL[][] = {
			...
			{ 0x6, MyCmd.Keycode.MULT_BACK_AND_HANG },
	...
	private void sendEQCmd(int style, int step) {
		...
		if (step != 0) {
			mHandlerRepeat.sendMessageDelayed(
					mHandlerRepeat.obtainMessage(0, style, step), 100);
		}
