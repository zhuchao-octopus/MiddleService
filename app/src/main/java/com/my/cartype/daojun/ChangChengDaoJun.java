...
public class ChangChengDaoJun extends Canbox {
	...
	private final static byte KEYS_WHEEL[][] = {
			...
			{ 0x10, MyCmd.Keycode.KEY_AIR_CONTROL }, 
	...
	private final static byte KEYS_WHEEL2[][] = { 
		...
		{ 0x3, MyCmd.Keycode.ROLL_NEXT },
		{ 0x4, MyCmd.Keycode.ROLL_PREV },
		{ 0x5, MyCmd.Keycode.POWER },
		{ 0x6, MyCmd.Keycode.PLAY_PAUSE },
		{ 0x7, MyCmd.Keycode.EJECT },
		{ 0x8, MyCmd.Keycode.NAVIGATION },
		{ 0x9, MyCmd.Keycode.HOME },
		{ 0xa, MyCmd.Keycode.BACK },
		{ 0xb, MyCmd.Keycode.BT },
		{ 0xc, MyCmd.Keycode.AUDIO },
		{ 0xd, MyCmd.Keycode.RADIO }, };
...
//		}
	...
	public void updateCompass(int compass) {
		...
		byte[] buf = new byte[] { (byte) (0xc9), 0x3,
				(byte) (direction & 0xff), 0, 0 };
