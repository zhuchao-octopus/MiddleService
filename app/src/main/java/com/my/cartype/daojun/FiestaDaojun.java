...
public class FiestaDaojun extends Canbox {
	...
	private final static byte KEYS_WHEEL2[][] = { 
		...
		{ 0x2, MyCmd.Keycode.DVD },
		{ 0x3, MyCmd.Keycode.RADIO },
		{ 0x4, MyCmd.Keycode.AUX_IN },
		{ 0x5, MyCmd.Keycode.MUTE },//yihu
		{ 0x8, MyCmd.Keycode.EJECT },
		{ 0x9, MyCmd.Keycode.AS },
		{ 0xa, MyCmd.Keycode.AUDIO },
		...
		{ 0x13, MyCmd.Keycode.NEXT },
		{ 0x14, MyCmd.Keycode.PREVIOUS },
		{ 0x15, MyCmd.Keycode.NEXT },
		
		{ 0x16, MyCmd.Keycode.NUMBER0 },
		{ 0x17, MyCmd.Keycode.NUMBER1 },
		{ 0x18, MyCmd.Keycode.NUMBER2 },
		{ 0x19, MyCmd.Keycode.NUMBER3 },
		{ 0x1a, MyCmd.Keycode.NUMBER4 },
		{ 0x1b, MyCmd.Keycode.NUMBER5 },
		{ 0x1c, MyCmd.Keycode.NUMBER6 },
		{ 0x1d, MyCmd.Keycode.NUMBER7 },
		{ 0x1e, MyCmd.Keycode.NUMBER8 },
		{ 0x1f, MyCmd.Keycode.NUMBER9 },
		{ 0x20, MyCmd.Keycode.NUMBER_STAR },
		{ 0x21, MyCmd.Keycode.NUMBER_POUND },
		{ (byte)0x23, MyCmd.Keycode.VOLUME_ROLL_UP },
		{ (byte)0x22, MyCmd.Keycode.VOLUME_ROLL_DOWN },
