...
public class BenzRaise extends Canbox{
	...
	private final static byte KEYS_WHEEL2[][] = {
		...
		{ 0x3, MyCmd.Keycode.VOLUME_UP },
		{ 0x4, MyCmd.Keycode.VOLUME_DOWN },
		{ 0x5, MyCmd.Keycode.KEY_TURN_D },
		{ 0x6, MyCmd.Keycode.KEY_TURN_A },
		{ 0x7, MyCmd.Keycode.PLAY_PAUSE },
//		{ 0x8, MyCmd.Keycode },
		{ 0x9, MyCmd.Keycode.BACK },
		{ 0xa, MyCmd.Keycode.BACKLIGHT_OFF },
	};
	...
	public int getOutTemp(byte[] data) {//
		...
		if (data[2] == 0x2) {
			...
			t = (int) ((short) (((data[4] & 0xff)) | ((data[3] & 0xff) << 8)));
		}
		return t;
	}
