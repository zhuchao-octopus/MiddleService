...
public class NissanRaise extends Canbox {
	...
	private void changeKeyType() {
		int type = 0;
		if (CarUtil.getModelId() == 2 || CarUtil.getModelId() == 5
				|| CarUtil.getModelId() == 22 || CarUtil.getModelId() == 52) {
			type = 1;
		}
	...
	private byte KEYS_WHEEL[][] = { { 0x1, AK_KEYPAD_VOLUME_A },
			...
			{ (byte) 0x72, KEY_GPS }, { (byte) 0x73, KEY_MENU },

			{ (byte) 0x71, KEY_BACK },

			{ (byte) 0x74, MyCmd.Keycode.KEY_TURN_A },
			{ (byte) 0x75, MyCmd.Keycode.KEY_TURN_D }, { 0x70, KEY_PLAYPAUSE },
			{ 0x61, KEY_NEXTSONG }, { 0x62, KEY_NEXTSONG },
			{ 0x63, KEY_NEXTSONG }, { 0x64, KEY_NEXTSONG },

			{ 0x60, KEY_PREVIOUSSONG }, { 0x65, KEY_PREVIOUSSONG },
			{ 0x66, KEY_PREVIOUSSONG }, { 0x67, KEY_PREVIOUSSONG },


			{ 0x24, MyCmd.Keycode.KEY_FM },
			{ 0x26, MyCmd.Keycode.KEY_AM },
			{ 0x25, MyCmd.Keycode.DVD },
			{ 0x27, MyCmd.Keycode.NUMBER1 },
			{ 0x28, MyCmd.Keycode.NUMBER2 },
			{ 0x29, MyCmd.Keycode.NUMBER3 },
			{ 0x2a, MyCmd.Keycode.NUMBER4 },
			{ 0x2b, MyCmd.Keycode.NUMBER5 },
			{ 0x2c, MyCmd.Keycode.NUMBER6 },
			{ 0x2d, MyCmd.Keycode.VOLUME_DOWN },
			{ 0x2e, MyCmd.Keycode.VOLUME_UP },
			{ 0x2f, MyCmd.Keycode.KEY_TURN_D },
			{ 0x30, MyCmd.Keycode.KEY_TURN_A },
			{ 0x31, MyCmd.Keycode.KEY_SEEK_PREV },
			{ 0x32, MyCmd.Keycode.KEY_SEEK_NEXT },
			{ 0x33, MyCmd.Keycode.MUTE },
			

			{ 0x40, MyCmd.Keycode.AUX_IN },
			{ 0x42, MyCmd.Keycode.KEYAMS_RPT },
			{ 0x43, MyCmd.Keycode.DVD },
			{ 0x44, MyCmd.Keycode.HOME },
			{ 0x45, MyCmd.Keycode.NAVIGATION },
			{ 0x47, MyCmd.Keycode.NAVIGATION },
			{ 0x4a, MyCmd.Keycode.BRIGHTNESS },
			{ 0x4e, MyCmd.Keycode.BRIGHTNESS },
			{ 0x4d, MyCmd.Keycode.SETUP },
			{ 0x4f, MyCmd.Keycode.SPEECH },
			{ 0x50, MyCmd.Keycode.AUDIO },
			{ 0x51, MyCmd.Keycode.EJECT },
	...
	private final static byte KEYS_WHEEL2[][] = {
			...
			{ 0x3, MyCmd.Keycode.KEY_FM }, { 0x9, KEY_FM },
	...
	public void setMediaMoreInfo(int source, int play, int total, int time,
		...
		if (MyCmd.SOURCE_DVD == source) {
			...
			data = new byte[] { (byte) 0xc0, 0x8, s, s2, 0, 0,
