...
public class BenTengRaise extends Canbox{
	...
	private final byte KEYS_WHEEL2[][] = {
		...
		{ 0xb, MyCmd.Keycode.NUMBER1 },
		{ 0xc, MyCmd.Keycode.NUMBER2 },
		{ 0xd, MyCmd.Keycode.NUMBER3 },
		{ 0xe, MyCmd.Keycode.NUMBER4 },
		{ 0xf, MyCmd.Keycode.NUMBER5 },
		{ 0x10, MyCmd.Keycode.NUMBER6 },
		...
		{ 0x17, MyCmd.Keycode.EASY_CONNECT },
		{ 0x18, MyCmd.Keycode.AUDIO },
		{ 0x19, MyCmd.Keycode.SPEECH },
		{ 0x1a, MyCmd.Keycode.BT },
		{ 0x1b, MyCmd.Keycode.KEY_RADIO_SCAN },
		{ 0x1c, MyCmd.Keycode.BACKLIGHT_OFF },
		{ 0x1d, MyCmd.Keycode.BT_DIAL },
		{ 0x1e, MyCmd.Keycode.BT_HANG },
		{ 0x1f, MyCmd.Keycode.BACK },
		{ 0x20, MyCmd.Keycode.HOME },
		{ 0x21, MyCmd.Keycode.EASY_CONNECT },
