...
//		buildCmdOutTemp((byte) 0x41, (byte) 0x10);
	...
	private final static byte KEYS_WHEEL2[][] = {
		...
		{ 0x8, MyCmd.Keycode.MULT_MUTE_AND_POWER },
		{ 0x9, MyCmd.Keycode.HOME },
		{ 0xa, MyCmd.Keycode.BACK },
		{ 0xb, MyCmd.Keycode.SETUP },
		{ 0xc, MyCmd.Keycode.BT },
		{ 0xd, MyCmd.Keycode.NAVIGATION },
		{ 0xe, MyCmd.Keycode.RADIO },
		{ 0x11, MyCmd.Keycode.PLAY_PAUSE },
//		{ 0x12, MyCmd.Keycode. },
		{ 0x13, MyCmd.Keycode.KEY_REPEAT },
		{ 0x14, MyCmd.Keycode.KEY_SHUFFLE },
		{ 0x15, MyCmd.Keycode.KEY_TURN_D },
		{ 0x16, MyCmd.Keycode.KEY_TURN_A },
		
		//this for OD jingyiX5 low config

		{ 0x31, MyCmd.Keycode.VOLUME_UP },
		{ 0x32, MyCmd.Keycode.VOLUME_DOWN },
		{ 0x33, MyCmd.Keycode.PREVIOUS },
		{ 0x34, MyCmd.Keycode.NEXT },
		{ 0x35, MyCmd.Keycode.KEY_SEEK_PREV },
		{ 0x36, MyCmd.Keycode.KEY_SEEK_NEXT },
		{ 0x37, MyCmd.Keycode.EQ },
		{ 0x38, MyCmd.Keycode.SETUP },
