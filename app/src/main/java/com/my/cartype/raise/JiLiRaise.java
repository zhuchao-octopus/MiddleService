...
public class JiLiRaise extends Canbox{
	...
	private final static byte KEYS_WHEEL[][] = {
		{ 0x1, AK_KEYPAD_VOLUME_A },
			...
			{ 0xb, MyCmd.Keycode.BT_DIAL },
			{ 0xc, MyCmd.Keycode.BT_HANG },
			{ 0xd, MyCmd.Keycode.HOME },
			{ 0xe, MyCmd.Keycode.PLAY_PAUSE },
			{ 0xf, MyCmd.Keycode.MODLE },
...
//			{ 0xb0, MyCmd.Keycode },
	...
	private byte[]	airData = new byte[8];
...
//			Util.zeroBuf(airData);
	...
	public void setMediaSrc(int source, byte type, byte[] b) {
		...
		byte[] mData = new byte[] { (byte) 0xc0, 0x5, 0x1, 0x1, b[0], b[1],
				b[2] };
