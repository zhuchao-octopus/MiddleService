...
public class DongNanRaise extends Canbox {
	...
	private final static byte KEYS_WHEEL[][] = {
			...
			{ 0x2, MyCmd.Keycode.VOLUME_DOWN }, { 0x4, MyCmd.Keycode.NEXT },
			{ 0x3, MyCmd.Keycode.PREVIOUS }, { 0x6, MyCmd.Keycode.MUTE },
			{ 0x7, MyCmd.Keycode.MODLE },

			{ 0x8, MyCmd.Keycode.SPEECH }, { 0x9, MyCmd.Keycode.BT },
			{ 0x25, MyCmd.Keycode.MULT_MUTE_AND_POWER },
			{ 0x26, MyCmd.Keycode.SETUP }, { 0x21, MyCmd.Keycode.RADIO },
			{ 0x22, MyCmd.Keycode.AUDIO }, { 0x23, MyCmd.Keycode.NAVIGATION },
	...
	{ 0x1, MyCmd.Keycode.HOME }, { 0x2, MyCmd.Keycode.NAVIGATION },
			{ 0x3, MyCmd.Keycode.AUDIO }, { 0x4, MyCmd.Keycode.NAVIGATION },
			{ 0x5, MyCmd.Keycode.BACK }, { 0x6, MyCmd.Keycode.SETUP },
