...
public class ChangChengC30Raise extends Canbox{
	...
	private final static byte KEYS_WHEEL[][] = {
		{ 0x1, AK_KEYPAD_VOLUME_A },
			...
			{ 0x20, MyCmd.Keycode.AS },
			{ 0x21, MyCmd.Keycode.RADIO },
			{ 0x22, MyCmd.Keycode.HOME },
			{ 0x23, MyCmd.Keycode.KEY_SEEK_PREV },
			{ 0x24, MyCmd.Keycode.KEY_SEEK_NEXT },
			{ 0x25, MyCmd.Keycode.KEY_SHUFFLE },
			{ 0x26, MyCmd.Keycode.KEY_REPEAT },
			{ 0x27, MyCmd.Keycode.BT_HANG },
			{ 0x28, MyCmd.Keycode.BT_DIAL },
			{ 0x29, MyCmd.Keycode.PREVIOUS },
			{ 0x2a, MyCmd.Keycode.NEXT },
			{ 0x2b, MyCmd.Keycode.VOLUME_UP },
			{ 0x2c, MyCmd.Keycode.VOLUME_DOWN },
			{ 0x2d, MyCmd.Keycode.POWER },
			{ 0x2e, MyCmd.Keycode.EJECT },
