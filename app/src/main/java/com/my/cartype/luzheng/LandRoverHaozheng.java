...
public class LandRoverHaozheng extends Canbox {
	...
	{ 0x2, AK_KEYPAD_VOLUME_D },
			...
			{ 0xb, KEY_NEXTSONG }, 
			{ 0xa, KEY_PREVIOUSSONG },
			{ 0xd, KEY_PLAYPAUSE }, 
			{ 0x19, KEY_MIC },
			

			{ 0x11, MyCmd.Keycode.VOLUME_ROLL_UP },
			{ 0x12, MyCmd.Keycode.VOLUME_ROLL_DOWN },
			{ 0x13, MyCmd.Keycode.ROLL_NEXT },
			{ 0x14, MyCmd.Keycode.ROLL_PREV },
			{ 0x16, MyCmd.Keycode.NAVIGATION },
			{ 0x17, MyCmd.Keycode.AUDIO },
			{ 0x18, MyCmd.Keycode.POWER },
			{ 0x1b, MyCmd.Keycode.HOME },
			{ 0x20, MyCmd.Keycode.SETUP },
			{ 0x21, MyCmd.Keycode.EQ },
			{ 0x22, MyCmd.Keycode.EJECT },
