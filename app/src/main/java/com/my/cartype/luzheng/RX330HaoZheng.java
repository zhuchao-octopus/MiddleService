...
public class RX330HaoZheng extends Canbox {
	...
	private final static byte KEYS_WHEEL[][] = { { 0x1, AK_KEYPAD_VOLUME_A },
			{ 0x2, AK_KEYPAD_VOLUME_D }, { 0x14, KEY_NEXTSONG },
			{ 0x13, KEY_PREVIOUSSONG }, { (byte) 0x87, KEY_MUTE },
	...
	{ 0x1, MyCmd.Keycode.PREVIOUS }, { 0x6, MyCmd.Keycode.PREVIOUS },
			{ 0x7, MyCmd.Keycode.PREVIOUS }, { 0x8, MyCmd.Keycode.PREVIOUS },
			{ 0x2, MyCmd.Keycode.NEXT }, { 0x3, MyCmd.Keycode.NEXT },
			{ 0x4, MyCmd.Keycode.NEXT }, { 0x5, MyCmd.Keycode.NEXT },

			{ 0x10, MyCmd.Keycode.KEY_TURN_A },
			{ 0x11, MyCmd.Keycode.KEY_TURN_D },
			{ 0x12, MyCmd.Keycode.PLAY_PAUSE }, { 0x13, MyCmd.Keycode.BACK },
			{ 0x14, MyCmd.Keycode.MENU }, { 0x15, MyCmd.Keycode.AUDIO },
	...
	{ 0x1, MyCmd.Keycode.KEY_AM }, { 0x2, MyCmd.Keycode.KEY_FM },
			{ 0x3, MyCmd.Keycode.KEY_FM }, { 0x4, MyCmd.Keycode.AUX_IN },
			{ 0x5, MyCmd.Keycode.NAVIGATION },
			{ 0x6, MyCmd.Keycode.NAVIGATION }, { 0x7, MyCmd.Keycode.MENU },
			{ 0x8, MyCmd.Keycode.SETUP }, { 0x9, MyCmd.Keycode.BRIGHTNESS },
			{ 0x10, MyCmd.Keycode.AUDIO },
			{ 0x11, MyCmd.Keycode.TIME_SETTING },
...
//	}
	...
	private byte[] mBufEq = new byte[8];
...
//		setEQVolume(mVolume);
	...
	public void startConnect() {
		...
		if (CarUtil.getCarType() != 0) {
			byte[] buf = new byte[] { (byte) 0xe2, 0x1,
					(byte) (CarUtil.getCarType()) };
			sendDataToCanbox(buf, buf.length);
			Util.doSleep(2);
		}
