...
public class Odyssey09_14BNR extends Canbox{
	...
	private final static byte KEYS_WHEEL2[][] = {
		...
		{ 0x12, MyCmd.Keycode.KEY_CAR_INFO},
		{ 0x13, MyCmd.Keycode.KEY_CAR_INFO},
		{ 0x14, MyCmd.Keycode.KEY_CAR_INFO},
		{ 0x15, MyCmd.Keycode.HOME},
		{ 0x16, MyCmd.Keycode.PLAY_PAUSE},
		{ 0x18, MyCmd.Keycode.BACK},
		{ 0x19, MyCmd.Keycode.PLAY_PAUSE},
		{ 0x1a, MyCmd.Keycode.EQ},
		{ 0x1d, MyCmd.Keycode.KEY_SEEK_NEXT},
