...
public class HyBNR extends Canbox{
	...
	private final static byte KEYS_WHEEL[][] = {
		...
		{ (byte)0x89, MyCmd.Keycode.MUTE },
		{ (byte)0x8a, MyCmd.Keycode.VOLUME_ROLL_UP },
		{ (byte)0x8b, MyCmd.Keycode.VOLUME_ROLL_DOWN },
	};
	...
	private byte[]	airDataEx = new byte[8];
	public void parseACInfo(byte[] data)
	{
		
		airDataEx[0] = (byte) ((data[2] & 0xec)
				| ((data[2] & 0x1) << 1)
				| ((data[6] & 0x04) >> 2));		
