package com.my.cartype.changyuantong;
...
public class Accord7ChangYuanTong9600 extends Canbox {
	...
	public Accord7ChangYuanTong9600() {
		sendCmd(CANBOX_WRITE_MCU_DATA, 0, new byte[] { 0x05, 0x01, 0x0, 0x3,
				0x0, 0x0 });
		sendCmd(CANBOX_WRITE_MCU_DATA, 0, new byte[] { 0x05, 0x02, 0x5, 0x3,
				0x5, 0x0 });
	}
	...
	private void parseACInfo(byte[] data, int len) {
		...
		if (airData[0] != mAirData[0] 
				|| airData[1] != mAirData[1]
				|| airData[2] != mAirData[2] 
				|| airData[3] != mAirData[3]
				|| airData[4] != mAirData[4]) {
			airControl = true;
