...
public class Mazda3Simple extends Canbox {
	...
	private final static byte KEYS_WHEEL[][] = { { 0x1, AK_KEYPAD_VOLUME_A },
			...
			{ 0x8, KEY_MIC }, { 0x9, KEY_BT_DIAL }, { 0xa, KEY_BT_HANG }, 
			 ...
			 { 0x22, MyCmd.Keycode.HOME }, 
			 { 0x23, MyCmd.Keycode.BACK }, 
			 { 0x24, MyCmd.Keycode.NAVIGATION }, 
			 { 0x25, MyCmd.Keycode.PLAY_PAUSE }, 
			 { 0x26, MyCmd.Keycode.PREVIOUS }, 
			 { 0x27, MyCmd.Keycode.NEXT }, 
			 { 0x28, MyCmd.Keycode.PREVIOUS }, 
			 { 0x29, MyCmd.Keycode.NEXT }, 
			 { 0x2a, MyCmd.Keycode.MUTE }, 
			 { 0x2b, MyCmd.Keycode.KEY_TURN_A }, 
			 { 0x2c, MyCmd.Keycode.KEY_TURN_D }, 
			 { 0x2d, MyCmd.Keycode.VOLUME_UP }, 
			 { 0x2e, MyCmd.Keycode.VOLUME_DOWN },
	};
