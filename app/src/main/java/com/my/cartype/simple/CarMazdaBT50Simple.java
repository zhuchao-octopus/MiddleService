...
public class CarMazdaBT50Simple extends Canbox {
	...
	private final static byte mKeyPannel[][] = {
		...
		{(byte) 0x86, MyCmd.Keycode.PLAY_PAUSE }, 
		{(byte) 0xf0, MyCmd.Keycode.VOLUME_UP }, 
		{(byte) 0xf1, MyCmd.Keycode.VOLUME_DOWN }, 
