...
public class Peugeot206307OldSimple extends Canbox {
	...
	{ 0x1, AK_KEYPAD_VOLUME_A }, { 0x2, AK_KEYPAD_VOLUME_D },
			{ 0x3, KEY_PREVIOUSSONG }, { 0x4, KEY_NEXTSONG },
			{ 0x5, KEY_SOURCE },

			{ 0x6, KEY_PREVIOUSSONG }, { 0x7, KEY_NEXTSONG },
			{ 0x13, MyCmd.Keycode.KEY_TURN_A },
			{ 0x14, MyCmd.Keycode.KEY_TURN_D }, { (byte) 0x80, KEY_HOME },
