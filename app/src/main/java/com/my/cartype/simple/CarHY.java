...
import com.my.canbox.SosManager;
...
public class CarHY extends Canbox {
	...
	private final static byte KEYS_PANNEL_S_M[][] = {
			...
			{ 0x3, KEY_PREVIOUSSONG }, { 0x4, KEY_NEXTSONG }, { 0x5, KEY_BT },
			{ 0xa, KEY_BT }, { 0x38, KEY_BT }, { 0x6, AK_KEYPAD_MUTE_FAKE },
			{ 0x12, KEY_MIC }, { (byte) 0x89, AK_KEYPAD_MUTE_FAKE },
			{ 0x7, KEY_MODE }, { (byte) 0x88, KEY_MODE },
			{ 0x9, MyCmd.Keycode.DARK }, { 0x30, MyCmd.Keycode.DARK },
			{ 0xb, KEY_MENU }, { 0xc, KEY_BACK }, { 0x0d, KEY_CH_UP },
			{ (byte) 0x83, KEY_CH_UP }, { 0x0e, KEY_CH_UP },
			{ (byte) 0x84, KEY_CH_DOWN }, { 0x0f, KEY_POWER },
			{ 0x3b, KEY_POWER }, { (byte) 0x87, KEY_POWER },
			{ 0x10, KEY_BT_HANG }, { 0x31, MyCmd.Keycode.NAVIGATION },
			{ 0x32, MyCmd.Keycode.NAVIGATION },
			{ 0x33, MyCmd.Keycode.NAVIGATION }, { 0x34, MyCmd.Keycode.SETUP },
			{ 0x35, MyCmd.Keycode.RADIO }, { 0x36, MyCmd.Keycode.RADIO },
			{ 0x37, MyCmd.Keycode.AUDIO },
			{ 0x39, MyCmd.Keycode.KEY_SEEK_PREV },
			{ (byte) 0x86, MyCmd.Keycode.KEY_SEEK_PREV },
			{ 0x3a, MyCmd.Keycode.KEY_SEEK_NEXT },
			{ (byte) 0x85, MyCmd.Keycode.KEY_SEEK_NEXT },
			{ 0x3c, AK_KEYPAD_VOLUME_A }, { (byte) 0x81, AK_KEYPAD_VOLUME_A },
			{ (byte) 0x8a, AK_KEYPAD_VOLUME_A }, { 0x3d, AK_KEYPAD_VOLUME_D },
			{ (byte) 0x82, AK_KEYPAD_VOLUME_D },
			{ (byte) 0x8b, AK_KEYPAD_VOLUME_D },
			{ (byte) 0x3e, MyCmd.Keycode.KEY_TURN_A },
			{ (byte) 0x3f, MyCmd.Keycode.KEY_TURN_D }, };
	...
	private final static byte KEYS_PANNEL_S_HIDE[][] = {
			...
			{ 0x12, KEY_MIC }, { (byte) 0x89, AK_KEYPAD_MUTE_FAKE },
			{ 0x7, KEY_MODE }, { (byte) 0x88, KEY_MODE },
			{ 0x9, MyCmd.Keycode.DARK }, { 0x30, MyCmd.Keycode.BT },
			{ 0xb, KEY_MENU }, { 0xc, KEY_BACK }, { 0x0d, KEY_CH_UP },
			{ (byte) 0x83, KEY_CH_UP }, { 0x0e, KEY_CH_UP },
			{ (byte) 0x84, KEY_CH_DOWN }, { 0x0f, KEY_POWER },
			{ 0x3b, KEY_POWER }, { (byte) 0x87, KEY_POWER },
	...
	private final static byte KEYS_PANNEL_NORMAL[][] = {
			...
			{ 0x32, MyCmd.Keycode.NAVIGATION },
			{ 0x33, MyCmd.Keycode.NAVIGATION }, { 0x34, MyCmd.Keycode.SETUP },
			{ 0x35, MyCmd.Keycode.PLAY_PAUSE }, { 0x36, MyCmd.Keycode.RADIO },
			{ 0x37, MyCmd.Keycode.AUDIO },
			{ 0x39, MyCmd.Keycode.KEY_SEEK_PREV },
			{ (byte) 0x86, MyCmd.Keycode.KEY_SEEK_PREV },
			{ 0x3a, MyCmd.Keycode.KEY_SEEK_NEXT },
	...
	private final static byte KEYS_PANNEL_KX5_M[][] = {
			...
			{ (byte) 0x84, KEY_CH_DOWN }, { 0x0f, KEY_POWER },
			{ 0x3b, KEY_POWER }, { (byte) 0x87, KEY_POWER },
			{ 0x10, KEY_BT_HANG }, { 0x31, MyCmd.Keycode.AUDIO },
			{ 0x32, MyCmd.Keycode.DARK }, { 0x33, MyCmd.Keycode.SETUP },
			{ 0x34, MyCmd.Keycode.SETUP }, { 0x35, MyCmd.Keycode.PLAY_PAUSE },
			{ 0x36, MyCmd.Keycode.HOME }, { 0x37, MyCmd.Keycode.RADIO },
			{ 0x39, MyCmd.Keycode.KEY_SEEK_PREV },
			{ (byte) 0x86, MyCmd.Keycode.KEY_SEEK_PREV },
			{ 0x3a, MyCmd.Keycode.KEY_SEEK_NEXT },
			{ (byte) 0x85, MyCmd.Keycode.KEY_SEEK_NEXT },
	...
	private final static byte KEYS_PANNEL_KX5_H[][] = {
			...
			{ 0x3b, KEY_POWER }, { (byte) 0x87, KEY_POWER },
			{ 0x10, KEY_BT_HANG }, { 0x31, MyCmd.Keycode.NAVIGATION },
			{ 0x32, MyCmd.Keycode.NAVIGATION }, { 0x33, MyCmd.Keycode.SETUP },
			{ 0x34, MyCmd.Keycode.SETUP }, { 0x35, MyCmd.Keycode.PLAY_PAUSE },
			{ 0x36, MyCmd.Keycode.RADIO }, { 0x37, MyCmd.Keycode.AUDIO },
			{ 0x39, MyCmd.Keycode.KEY_SEEK_PREV },
			{ (byte) 0x86, MyCmd.Keycode.KEY_SEEK_PREV },
			{ 0x3a, MyCmd.Keycode.KEY_SEEK_NEXT },
			{ (byte) 0x85, MyCmd.Keycode.KEY_SEEK_NEXT },
	...
	private final static byte KEYS_SPORTAGE[][] = {
		...
		{ (byte) 0x84, KEY_CH_DOWN }, { 0x0f, KEY_POWER },
		{ 0x3b, KEY_POWER }, { (byte) 0x87, KEY_POWER },
		{ 0x10, KEY_BT_HANG }, { 0x31, MyCmd.Keycode.HOME },
		{ 0x32, MyCmd.Keycode.BT }, { 0x33, MyCmd.Keycode.SETUP },
		{ 0x34, MyCmd.Keycode.SETUP }, { 0x35, MyCmd.Keycode.PLAY_PAUSE },
		{ 0x36, MyCmd.Keycode.RADIO }, { 0x37, MyCmd.Keycode.AUDIO },
		{ 0x39, MyCmd.Keycode.KEY_SEEK_PREV },
		{ (byte) 0x86, MyCmd.Keycode.KEY_SEEK_PREV },
	...
	private boolean isOneKey(byte b) {
		if (((b & 0xff) >= 0x81) || ((b & 0xff) == 0x3c)
				|| ((b & 0xff) == 0x3d) || ((b & 0xff) == 0x3e)
				|| ((b & 0xff) == 0x3f)) {
			return true;
		}
...
//				}
		...
		if (key != 0) {
			...
			if (((data[2] & 0xff) == 0x81) || ((data[2] & 0xff) == 0x82)
					|| ((data[2] & 0xff) == 0x3C) || ((data[2] & 0xff) == 0x3D)) {
	...
	private void do1050SosCustomCmd(byte[] data) {
		if (MachineConfig.VALUE_SYSTEM_UI22_1050.equals(GlobalDef.mSystemUI)
				||MachineConfig.VALUE_SYSTEM_UI_1050_2.equals(GlobalDef.mSystemUI)
	...
	public void updateTime() {
		...
		byte[] buf = new byte[] { (byte) 0xc6, 0x08, 0x01, 0x0, 0x0, 0x0, h, m,
				s, ampm };
		sendDataToCanbox(buf, buf.length);
	}
