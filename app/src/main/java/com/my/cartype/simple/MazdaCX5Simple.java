...
public class MazdaCX5Simple extends Canbox {
	...
	private final static byte KEYS_WHEEL[][] = { { 0x1, AK_KEYPAD_VOLUME_A },
			...
			{ 0x11, KEY_NEXTSONG }, { 0x10, KEY_PREVIOUSSONG },
			{ 0x14, KEY_NEXTSONG }, { 0x13, KEY_PREVIOUSSONG },
			{ 0x15, KEY_BACK },

			{ 0x16, KEY_PLAYPAUSE },

			{ (byte) 0x81, KEY_SET }, { (byte) 0x82, KEY_GPS },
			{ (byte) 0x83, KEY_MEDIA },
			{ (byte) 0x84, MyCmd.Keycode.KEY_TURN_A },
			{ (byte) 0x85, MyCmd.Keycode.KEY_TURN_D },
