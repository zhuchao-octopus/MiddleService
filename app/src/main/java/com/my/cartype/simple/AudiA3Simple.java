...
public class AudiA3Simple extends Canbox {
	...
	public AudiA3Simple() {
		...
		sendCmd(CANBOX_WRITE_MCU_DATA, 0, new byte[] { 0x05, 0x01, 0x2, 0x3,
				0x0, 0x0 });
		sendCmd(CANBOX_WRITE_MCU_DATA, 0, new byte[] { 0x05, 0x02, 0x3, 0x4,
				0x3, 0x0 });
...
//		Log.d("cde", "sendCmd:" + Util.byteArrayToHex(send));
	...
	{ 0x3, KEY_BT }, { 0x4, KEY_MUTE }, { 0x5, KEY_PREVIOUSSONG },
			{ 0x6, KEY_NEXTSONG }, { 0x7, KEY_SOURCE },
			{ 0x13, KEY_PREVIOUSSONG }, { 0x14, KEY_NEXTSONG }
