...
public class AlphaBagoo extends Canbox {
	...
	private final static byte KEYS_WHEEL[][] = { { 0x2, AK_KEYPAD_VOLUME_A },
			{ 0x3, AK_KEYPAD_VOLUME_D }, { 0x4, KEY_NEXTSONG },
			{ 0x5, KEY_PREVIOUSSONG }, { 0x13, KEY_NEXTSONG },
			{ 0x12, KEY_PREVIOUSSONG }, { 0x1, KEY_MUTE },
	...
	public void setMediaMoreInfo(int source, int play, int total, int time,
		...
		byte[] data = new byte[] { (byte) 0x82, 0x5, 0x2, 0, (byte) (play), 0,
				0 };
		sendDataToCanbox(data, data.length);
