...
//		buildCmdAngle((byte) 0x29, (byte) 0x5, 0x1518);
	...
	private final static byte KEYS_WHEEL[][] = {
		...
		{ (byte)0x8c, MyCmd.Keycode.PLAY_PAUSE },
		{ (byte)0x8e, MyCmd.Keycode.HOME },
		{ 0x30, MyCmd.Keycode.VOLUME_UP },
		{ 0x31, MyCmd.Keycode.VOLUME_DOWN },
		{ 0x32, MyCmd.Keycode.PREVIOUS },
		{ 0x33, MyCmd.Keycode.NEXT },
		{ 0x34, MyCmd.Keycode.PREVIOUS },
		{ 0x35, MyCmd.Keycode.NEXT },
		{ 0x36, MyCmd.Keycode.PREVIOUS },
		{ 0x37, MyCmd.Keycode.NEXT },
		{ 0x38, MyCmd.Keycode.PLAY_PAUSE },
		{ 0x40, MyCmd.Keycode.PREVIOUS },
		{ 0x41, MyCmd.Keycode.NEXT },
		{ 0x42, MyCmd.Keycode.PREVIOUS },
		{ 0x43, MyCmd.Keycode.NEXT },
		{ 0x44, MyCmd.Keycode.PREVIOUS },
		{ 0x45, MyCmd.Keycode.NEXT },
		{ 0x46, MyCmd.Keycode.PREVIOUS },
		{ 0x47, MyCmd.Keycode.NEXT },
		{ 0x48, MyCmd.Keycode.PREVIOUS },
