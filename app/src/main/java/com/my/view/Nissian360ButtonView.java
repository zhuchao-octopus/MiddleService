...
public class Nissian360ButtonView {
	...
	public Nissian360ButtonView(Context context) {
		...
		mLayoutParams = new WindowManager.LayoutParams(660, 380, 0, 0,
				LayoutParams.TYPE_PHONE, LayoutParams.FLAG_LAYOUT_NO_LIMITS,
		...
		mViewMicButton = ((LayoutInflater) context
				...
				R.layout.nissan360button, null);

		Drawable d = Drawable
				.createFromPath("/mnt/paramter/icon/mic_button.png");
		if (d != null) {
			((ImageView) mViewMicButton.findViewById(R.id.mic_button))
					.setImageDrawable(d);
		}

		mViewMicButton.findViewById(R.id.mic_button).setOnClickListener(
				new OnClickListener() {
					@Override
...
//						}
		...
		mViewMicButton.findViewById(R.id.mic_button).setOnLongClickListener(
		...
		mViewMicButton.findViewById(R.id.mic_button).setOnTouchListener(
				new OnTouchListener() {
					...
					public boolean onTouch(View v, MotionEvent event) {
						...
						case MotionEvent.ACTION_MOVE:
							...
							mWindowManager.updateViewLayout(mViewMicButton,
									mLayoutParamsMicButton);
